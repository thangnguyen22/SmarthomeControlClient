...
public class MainActivity extends ActionBarActivity implements ViewAnimator.ViewAnimatorListener {
    ...
    private void createMenuList() {
        ...
        list.add(menuItem);
        SlideMenuItem menuItem2 = new SlideMenuItem(ContentFragment.SCRIPT, R.drawable.icn_2);
        list.add(menuItem2);
    ...
    public ScreenShotable onSwitch(Resourceble slideMenuItem, ScreenShotable screenShotable, int position) {
        switch (slideMenuItem.getName()) {
            ...
            case ContentFragment.HOME:{
                this.startActivity(new Intent(this, ListRoomActivity.class));
                try
                {
                    this.overridePendingTransition(R.anim.disappear_top_left_in, R.anim.disappear_top_left_out);
                }
                catch (Exception e) {
                    Toast.makeText(this, "An error occured " + e.toString(), Toast.LENGTH_LONG).show(); }
            }
            return screenShotable;
            case ContentFragment.SCRIPT:{
                this.startActivity(new Intent(this, GroupDeviceActivity.class));
                try
                {
                    this.overridePendingTransition(R.anim.disappear_top_left_in, R.anim.disappear_top_left_out);
                }
            ...
            default:
            {
                this.startActivity(new Intent(this, AlarmActivity.class));
                try
                {
                    this.overridePendingTransition(R.anim.disappear_top_left_in, R.anim.disappear_top_left_out);
                }
